...
select 'equipment.eq_data_raw' as table_nm, count(*) cnt 
  from equipment.eq_data_raw;                           

select 'equipment.eq_data_raw_with_array ' as table_nm, count(*) cnt 
  from  equipment.eq_data_raw_with_array;

select 'equipment.eq_data_raw_with_array_unnest' as table_nm
     ,  (select count(*) 
